...
public class DateTimeHelper {
    ...
    public static java.util.Date toDateUntil(java.sql.Date d){
    ...
    public static java.util.Date toDateSql(java.util.Date d){
        d= removeTime(d);
    ...
    public static ArrayList<java.sql.Date> 
            getDateList(java.sql.Date from , java.sql.Date to){
                ...
                while (true)
                {
                    ...
                    dates.add((java.sql.Date) toDateSql(d));
                    days++;
    ...
    private static Date toDateUtil(java.sql.Date from) {
